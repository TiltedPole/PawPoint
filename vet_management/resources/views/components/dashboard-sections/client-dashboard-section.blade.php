        ...
        <div class="col-md-4 col-sm-6 content-card">
            <div class="card-big-shadow">
                <div class="card card-just-text" data-background="color" data-color="blue" data-radius="none">
                    <div class="content">
                        <h4 class="title"><a href="#">Activity Feed</a></h4>
                ...
                <div class="card-big-shadow">
                    <div class="card card-just-text" data-background="color" data-color="green" data-radius="none">
                        <div class="content" style="height: 150px">
                            ...
                            <h4 class="title"><a href="{{ route('clinics.view') }}">See all Clinics</a></h4>
                            <p class="description">View all available clinics</p>
                        </div>
                    </div> <!-- end card -->
                </div>
            </div>
                ...
                <div class="card-big-shadow">
                    <div class="card card-just-text" data-background="color" data-color="green" data-radius="none">
                        <div class="content" style="height: 300px">
                            ...
                            <h4 class="title"><a href="#">{{ $clinic->first()->name }}</a></h4>
                            {{-- <form id="removeClinic" method="POST" action="/removeClinic/{{ Auth::user()->id }}">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn btn-secondary">Leave Clinic</button>
                            </form> --}}
                            <a class="btn text-white btn-secondary m-1 me-3 col" data-toggle="modal"
                                data-target="#leaveClinicModal"role="button">Leave Clinic
                            </a>
                        </div>
                    </div> <!-- end card -->
                </div>
            </div>
            <div class="modal fade" id="leaveClinicModal" tabindex="-1" role="dialog"
                aria-labelledby="leaveClinicModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="leaveClinicModalLabel">Confirm Leave
                            </h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <form id="deleteForm" method="POST" action="/leaveClinic/{{ Auth::user()->id }}">
                                @csrf
                                @method('PUT')
            ...
            <div class="card-big-shadow">
                <div class="card card-just-text" data-background="color" data-color="yellow" data-radius="none">
                    <div class="content" style="height: 150px">
                        ...
                        <h4 class="title"><a href="{{ route('appointments.view') }}">Appointments</a></h4>
                        <p class="description">Manage your pets appointments</p>
                    </div>
                </div> <!-- end card -->
            </div>
        </div>
