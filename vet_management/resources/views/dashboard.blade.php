...
<body>
        ...
        <div class="row">
                    ...
                    <ul class="nav flex-column py-3">
                        <li class="nav-item">
                            <button type="button" class="btn btn-light w-100">
                                <a class="nav-link dashboard-nav active" href="#dashboard-section">
                        ...
                        <li class="nav-item">
                            <button type="button" class="btn btn-light w-100">
                                <a class="nav-link dashboard-nav" href="#manage-pets-section">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <li class="nav-item">
                            <button type="button" class="btn btn-light w-100">
                                <a class="nav-link dashboard-nav" href="#shop-section">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <li class="nav-item">
                            <button type="button" class="btn btn-light w-100">
                                <a class="nav-link dashboard-nav" href="#message-board-section">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <li class="nav-item">
                            <button type="button" class="btn btn-light w-100">
                                <a class="nav-link dashboard-nav" href="#care-plan-section">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <div id="dashboard-section">
                    <h2>Dashboard</h2>
                    @if (isset($clinic) && $clinic->count() > 0)
                        <x-dashboard-sections.client-dashboard-section :clinic="$clinic" />
                    @else
                        <x-dashboard-sections.client-dashboard-section />
                    @endif

                </div>
                <div id="manage-pets-section" style="display: none;">
                    <h2>My Pets</h2>
                    @if (Session::has('success'))
                        <div class="alert alert-success">
                            {{ Session::get('success') }}
                    ...
                    @endif
                    <x-dashboard-sections.manage-pets :patients="$patients" />
                </div>
                <div id="shop-section" style="display: none;">
                    <h2>Shop</h2>
                    <x-dashboard-sections.shop />
                </div>
                <div id="message-board-section" style="display: none;">
                    <h2>Message Board</h2>
                    {{-- {{dd($messages)}} --}}
                    @if (isset($clinic) && $clinic->count() > 0)
                        <x-dashboard-sections.message-board :clinic="$clinic" :messages="$messages" />
                    @else
                        You must sign up to a clinic!
                    @endif
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (openSection === 'manage-pets') {
                // Display the "manage-pets" section
                document.querySelectorAll("main > div").forEach(function(section) {
                    section.style.display = "none";
                });
                document.getElementById("manage-pets-section").style.display = "block";
            }
